...
__DEFINE__(1633654599197, function(require, module, exports) {
...
}, function(modId) {var map = {"./lib/AesCtr.js":1633654599198}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1633654599198, function(require, module, exports) {
...
module.exports = {
    ...
    encrypt: function (plaintext, password, nBits) {
        ...
        // ------------ perform encryption ------------
        const ciphertextBytes = this.nistEncryption(plaintextBytes, key, counterBlock);
        ...
        const ciphertextB64 =  this.base64Encode(nonceStr+ciphertextUtf8);
     ...
     * @private
     */
    nistEncryption: function (plaintext, key, counterBlock) {
    ...
    decrypt: function (ciphertext, password, nBits) {
        ...
        // ------------ perform decryption ------------
        const plaintextBytes = this.nistDecryption(ciphertextBytes, key, counterBlock);
        ...
        const plaintext = this.utf8Decode(plaintextUtf8);
     ...
     * @private
     */
    nistDecryption: function (ciphertext, key, counterBlock) {
        const blockSize = 16; // block size fixed at 16 bytes / 128 bits (Nb=4) for AES
...
//export { AesCtr };
}, function(modId) { var map = {"./Aes.js":1633654599199}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1633654599199, function(require, module, exports) {
/**
...
return __REQUIRE__(1633654599197);
})()
